                ...
                <div class="row text-center" >
                    <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="product-thumbnail">購買人姓名</th>
                                            <th class="product-name">電話</th>
                                            <th class="product-price">地址</th>
                                            <th class="product-quantity">取貨方式</th>
                                            <th class="product-subtotal">付款方式</th>
                                            <th class="product-remove">總金額</th>
                                            <th class="product-remove">狀態</th>
                                            <th class="product-remove">購買項目</th>
