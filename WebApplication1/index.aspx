<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication1.text" %>
                        ...
                        <div class="menumenu__container clearfix">
                            ...
                            <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <asp:LinkButton ID="HyperLink3" runat="server">您好</asp:LinkButton>
                                    </div>
                                    <div class="header__account">
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <a href="checkout.aspx">
                                            <span class="htc__qua"><asp:Literal ID="Literal3" runat="server"></asp:Literal></span>
                                    </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                ...
                                <div class="ht__pro__qun">
                                   <div class='send__btn'><asp:LinkButton ID="LinkButton3" class='fr__btn' Visible="false"  runat="server" PostBackUrl="edit_Product.aspx?New=Yes">新增商品</asp:LinkButton></div>
                                </div>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            $('#pagination-demo').twbsPagination({
                totalPages: <asp:Literal ID="Literal2" runat="server"></asp:Literal>,
